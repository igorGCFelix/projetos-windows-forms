...
namespace exemplo_crud
{
    class conexao
    {
        ...
        {
            servidor = "127.0.0.1";
            //127.0.0.1 - número do servidor local ou seja o próprio computador, para conexões online necessário colocar o número do servidor na internet.
            database = "crud_csharp";
            //Database que iremos criar futuramente
            usuario = "root";
            senha = "";
            //usuário e senha são padrões (root e senha branco) para conexões remota necessário substituir por usuário e senha fornecido
            string conexaostring;
            conexaostring = "SERVER= " + servidor + ";" + "DATABASE= " + database + ";" + "UID=" + usuario + ";" + "PASSWORD= " + senha + ";";
            conectar = new MySqlConnection(conexaostring);
            //MySqlConnection - utilizar a string conexaostring para conectar ao banco de dados
        }
